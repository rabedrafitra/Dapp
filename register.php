      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="" method="post" class="sign-in-form">
            ...
            <input type="submit" value="HISORATRA" class="btn solid" name="signup"/>
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>TONGASOA</h3>
            <p>
              Eto amin'ny ESThER Play. Fijerena horonantsary fampianarana, torinteny, vaovao samihafa, fanadihadiana.
            </p>
