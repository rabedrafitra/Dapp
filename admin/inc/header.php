...
<head>
	<meta charset="UTF-8">
	<title>Library Management ESThER</title>
	...
	<link rel="stylesheet" href="inc/css/crayon.css">
				...
				<div class="sidebar-menu">
	                ...
	                <ul>
    					...
    					<li class="menu <?php if($page=='tinfo'){ echo 'active';} ?>">
      						<a href="all-teacher-info.php"><i class="fas fa-desktop"></i>Information membre</a>
    					</li>
    					<li class="menu menu-toggle2">
      						<a href="#"><i class="fas fa-location-arrow"></i>Gestion des livres <span class="fa fa-chevron-down"></span></a>
      						<ul class="menus2">
      							<li><a href="add-book.php">Ajout de livre</a></li>
      							<li><a href="display-books.php">Affichage des livres</a></li>
      						</ul>
    					</li>
	                   <li class="menu menu-toggle1">
    					...
    					<li class="menu menu-toggle3">
      						...
      						<ul class="menus3">
								  ...
								  <li><a href="status.php">verification utilisateur</a></li>
      						</ul>
    					</li>
