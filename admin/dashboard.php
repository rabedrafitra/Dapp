		...
		<div class="dashboard-header">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<div class="left">
							<p><span>Tableau de bord</span>Panneau de Contrôle</p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="right text-right">
							<a href="dashboard.php"><i class="fas fa-home"></i>home</a>
							<span class="disabled">Tableau de bord</span>
						</div>
					</div>
				</div>
				<div class="row counterup">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box3">
							...
							<div class="text">
								<h4 class="mt-20"><a href="display-books.php">Gestion des livres</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box4">
							...
							<div class="text">
								<h4 class="mt-20"><a href="add-student.php">Gestion des utilisateurs</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
